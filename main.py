...
if __name__ == "__main__":
    ...
    #     data.append(torch.transpose(data_generator.generate_data(2), 1, 0))
    ...
    true_causality_graph = torch.stack(causalities.generate_causalities(input_tokens[:100], "retrain", model_parameters))
    print("causality graph generated by the grand true method:")
    print(true_causality_graph)

    causality_graph = torch.stack(causalities.generate_causalities(input_tokens[:100], "constant series", model_parameters))
